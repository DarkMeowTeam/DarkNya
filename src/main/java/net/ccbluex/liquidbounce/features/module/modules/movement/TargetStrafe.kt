...
class TargetStrafe : Module() {
    ...
    private fun canStrafe(target: EntityLivingBase?): Boolean {
        return target != null && (!holdSpaceValue.get() || mc.player.movementInput.jump) && (!onlySpeedValue.get() || DarkNya.moduleManager[Speed::class.java]!!.state)
    }
    ...
    fun toggleStrafe(): Boolean {
        return targetEntity != null && (!holdSpaceValue.get() || mc.player.movementInput.jump) && (!onlySpeedValue.get() || DarkNya.moduleManager[Speed::class.java]!!.state)
    }
