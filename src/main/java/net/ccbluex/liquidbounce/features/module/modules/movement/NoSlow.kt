...
class NoSlow : Module() {
    ...
    val killAura = DarkNya.moduleManager[KillAura::class.java] as KillAura
    ...
    private val isBlocking: Boolean
        get() = (mc.player!!.isHandActive || (DarkNya.moduleManager[KillAura::class.java] as KillAura).blockingStatus) && mc.player!!.heldItemMainhand != null && mc.player!!.heldItemMainhand!!.item is ItemSword
