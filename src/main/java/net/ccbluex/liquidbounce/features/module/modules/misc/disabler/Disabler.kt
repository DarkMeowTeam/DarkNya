...
class Disabler : Module() {
    ...
    fun onPacket(event: PacketEvent){
        ...
        val killAura = DarkNya.moduleManager.getModule(KillAura::class.java) as KillAura
    ...
    fun getGrimPost(): Boolean {
        val disabler = DarkNya.moduleManager.getModule(Disabler::class.java) as Disabler
