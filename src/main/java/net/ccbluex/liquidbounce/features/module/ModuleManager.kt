...
class ModuleManager : Listenable {
    ...
    init {
        DarkNya.eventManager.registerListener(this)
    }
    ...
    fun registerModule(module: Module) {
        ...
        DarkNya.eventManager.registerListener(module)
    }
    ...
    fun unregisterModule(module: Module) {
        ...
        DarkNya.eventManager.unregisterListener(module)
    }
    ...
    internal fun generateCommand(module: Module) {
        ...
        DarkNya.commandManager.registerCommand(ModuleCommand(module, values))
    }
