...
public class GuiAdd extends GuiScreen {
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        ...
        switch (button.id) {
            case 0:
                ...
                break;
            case 1:
                if (DarkNya.fileManager.accountsConfig.accountExists(username.getText())) {
    ...
    private void addAccount(final String name, final String password) {
        if (DarkNya.fileManager.accountsConfig.accountExists(name)) {
            status = "§cThe account has already been added.";
            return;
        }
        ...
        new Thread(() -> {
            ...
            DarkNya.fileManager.accountsConfig.getAccounts().add(account);
