...
public class ClickGui extends GuiScreen {
        ...
        for (final ModuleCategory category : ModuleCategory.values()) {
            panels.add(new Panel(category.getDisplayName(), 100, yPos, width, height, false) {
                ...
                public void setupItems() {
                    for (Module module : DarkNya.moduleManager.getModules())
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        final double scale = ((ClickGUI) Objects.requireNonNull(DarkNya.moduleManager.getModule(ClickGUI.class))).scaleValue.get();
        ...
        switch (((ClickGUI) Objects.requireNonNull(DarkNya.moduleManager.getModule(ClickGUI.class))).backgroundValue.get()) {
            case "Default":
    ...
    public void onGuiClosed() {
        DarkNya.fileManager.saveConfig(DarkNya.fileManager.clickGuiConfig);
    }
