    ...
    override fun drawElement(): Border? {
        ...
        when (modeValue.get().toLowerCase()){
            "tomk" -> {
                ...
                Fonts.posterama40.drawString("Kill:" + DarkNya.combatManager.kill.toString(),30f, Fonts.posterama30.fontHeight * 4.5f + 8f, Color.WHITE.rgb)
            ...
            "fdp"->{
                ...
                FontLoaders.F16.drawString(DarkNya.combatManager.kill.toString(), 135F - FontLoaders.F16.getStringWidth(DarkNya.combatManager.kill.toString()), 20.0f, Color(infoR.get(), infoG.get(), infoB.get(),infoAlpha.get()).rgb)

                // Deaths
                FontLoaders.F16.drawString("Deaths", 5.0F, 30.0F, Color(textR.get(), textG.get(), textB.get(),textAlpha.get()).rgb)
                FontLoaders.F16.drawString(DarkNya.combatManager.death.toString(), 135F - FontLoaders.F16.getStringWidth(DarkNya.combatManager.death.toString()), 30.0f, Color(infoR.get(), infoG.get(), infoB.get(),infoAlpha.get()).rgb)
                GL11.glPopMatrix()
            }
            "skid" -> {
                x = 150F
