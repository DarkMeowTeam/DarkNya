...
public class ValuesConfig extends FileConfig {
    ...
    protected void loadConfig() throws IOException {
        ...
        while(iterator.hasNext()) {
            ...
            if (entry.getKey().equalsIgnoreCase("CommandPrefix")) {
                DarkNya.commandManager.setPrefix(entry.getValue().getAsCharacter());
                ...
                final Module module = DarkNya.moduleManager.getModule(entry.getKey());
    ...
    protected void saveConfig() throws IOException {
        ...
        jsonObject.addProperty("CommandPrefix", DarkNya.commandManager.getPrefix());
        ...
        DarkNya.moduleManager.getModules().stream().filter(module -> !module.getValues().isEmpty()).forEach(module -> {
